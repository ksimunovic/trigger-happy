...
function triggerhappy_load_woocommerce_nodes( $nodes ) {
	$nodes['woocommerce'] = array(
		...
		'woocommerce_quantity_input_args' => array(
...
function triggerhappy_load_woocommerce_data_types( $thdatatypes ) { }
...
add_filter(
	'triggerhappy_resolve_field_wc_product__meta_data', function( $result, $obj, $fieldName ) {
