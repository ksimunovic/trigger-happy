...
class TriggerHappy {
	...
	public function init_hooks() {
		...
		add_action( 'triggerhappy_load_nodes', [ $this, 'load_nodes' ], 20 );
		add_action( 'plugins_loaded', [ $this, 'initialize_post_type' ] );
		add_action( 'plugins_loaded', [ $this, 'init_nodes' ] );
	 ...
	 */
	public static function create_field( $name, $type = 'flow', $opts = [] ) {
	...
	function init_nodes() {
		...
		$flows = get_posts( [ 'post_type' => 'th_flow' ] );
