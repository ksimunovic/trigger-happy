( function( tinymce ) {
	...
	tinymce.ui.Factory.add( 'TriggerHappyFieldOperations', tinymce.ui.Control.extend( {
		renderHtml: function() {
			return (
				'<div id="' + this._id + '" class="triggerhappy-field-operations">' +
	...
	tinymce.PluginManager.add( 'wpflowexpression', function( editor ) {
		var toolbar;
		var editToolbar;
		var previewInstance;
		var inputInstance;
		...
		editor.addCommand( 'triggerhappy_expression_edit', function() {
...
*/
		editor.on( 'wptoolbar', function( event ) {
			...
			var linkNode = editor.dom.getAttrib(event.element,"class") == "node-expression-data-tag" ? event.element : null,
				$linkNode, href, edit;
		...
		editor.addButton( 'triggerhappy_expression_edit', {
			type: 'TriggerHappyFieldOperations',
			onPostRender: function() {
				var self = this;
				editor.on('NodeChange', function(e) {
					var linkNode = editor.dom.getAttrib(e.element,"class") == "node-expression-data-tag" ? e.element : null;
					if (linkNode) {
					 editor.mountOperationsPanel(e.element, self.getEl());
					}
				});
