...
this.handleClick( e );
        ...
        {! pluginIcon && 'trigger' == this.props.node.nodeType && <div className={'node-icon node-icon--' + this.props.node.nodeType}>
            <i className="fa fa-bolt"></i>
            </div>
        }
        {! pluginIcon && 'action' == this.props.node.nodeType && <div className={'node-icon node-icon--' + this.props.node.nodeType}>
            <i className="fa fa-tasks"></i>
            </div>
        }

        {! pluginIcon && 'condition' == this.props.node.nodeType && <div className={'node-icon node-icon--' + this.props.node.nodeType}>
