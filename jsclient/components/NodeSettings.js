...
import {setExpression, setNodeTitle } from '../actions';
...
class NodeSettings extends React.Component {
	...
	render() {
		return (<div>
			...
			<h4 className="node-settings-title">
				<input className="node-editable-title" value={this.getCaption()} onChange={(e)=>this.setCaption(e.target.value)} />



			 </h4>
			 {this.props.selectedNode.helpText && (<p className="node-help-text">{this.props.selectedNode.helpText}
			 </p>)}
			<NodeConnectorList fieldTypes={this.props.fieldTypes} nodeIndex={this.props.nodeIndex} setExpression={this.props.setExpression} fetchNode={this.props.fetchNode} node={this.props.selectedNode} type="input" items={this.props.settings} />
