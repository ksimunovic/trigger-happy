...
class ExpressionEditor extends React.Component {
    ...
    createTagNode( char ) {
        ...
        React.render( <span data-tag='' className='node-expression-data-tag'>
 ...
 return ' ' + m.toUpperCase();
    ...
    render() {
        ...
        return (
            ...
            <div className={'node-control-container ' + ( this.props.errorMessage && 'node-error' || '' )}>	<div ref={( el ) => {
 this.element = el;
}}  className="node-editable-setting">	<textarea id={'expr_' + this.props.nodeId + '__' + this.props.name} name={'expr_' + this.props.nodeId + '__' + this.props.name} type="text" ref={el=>this.textbox = el} value={this.getValue()}></textarea>	</div>
            {this.props.value &&
