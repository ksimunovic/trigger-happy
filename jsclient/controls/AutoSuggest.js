...
class AutoSuggest extends React.Component {
 ...
 this.element = el;
                ...
                <input placeholder="Type to search..." type="text" value={this.state.text} className="node-editable-text" onBlur={( v )=>this.ensureSelected()} onChange={( v )=>this.toggleSearch( v.target.value )} />	</div>
