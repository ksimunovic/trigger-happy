...
const _ = require ('lodash')
 ...
 class OperationsPanel extends React.Component {
     render() {
         ...
         let style = {};
         if (this.props.operationX > 0 || this.props.operationY > 0)
            this.style = {left: this.props.operationX, top: this.props.operationY + 30 };
         ...
         {this.props.selectedOperation && this.props.selectedOperation != null && fieldTypeMethods[this.props.selectedOperation] && (
             <div>
